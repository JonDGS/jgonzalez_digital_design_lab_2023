...
vcom -93 -work work {D:/Utilities/Documents/GITHUB/jgonzalez_digital_design_lab_2023/Sumador/fourBitAdder_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi -L rtl_work -L work -voptargs="+acc"  fourBitAdder_tb
